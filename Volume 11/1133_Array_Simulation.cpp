...
template<typename T>
ostream& operator<<(ostream& os, const vector<T>& intermediate_array) { for (typename vector<T>::size_type i = 0; i < intermediate_array.size(); ++i) { os << intermediate_array[i]; if (i + 1 < intermediate_array.size()) { os << ' '; } } return os; }
template<typename T>
istream& operator>>(istream& is, vector<T>& intermediate_array) { for (typename vector<T>::size_type i = 0; i < intermediate_array.size(); ++i) { is >> intermediate_array[i]; } return is; }
